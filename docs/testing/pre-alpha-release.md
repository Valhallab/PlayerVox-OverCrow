...
`v0.1.0-pre-alpha.1`. Check only results you personally observe.
...
sudo pacman -U overcrow-bin-0.1.0prealpha1-1-x86_64.pkg.tar.zst
overcrow-control
```
...
Stop OverCrow, close the Control Center, then run:
