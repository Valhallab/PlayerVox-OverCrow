...
grep -Fq 'gnupg' "$workflow"
grep -Fq 'libarchive-tools' "$workflow"
...
grep -Fq 'packaging/apt/*.sh' "$workflow"
grep -Fq 'packaging/deb/*.sh' "$workflow"
grep -Fq 'packaging/release/*.sh' "$workflow"
grep -Fq 'packaging/rpm/*.sh' "$workflow"
...
grep -Fq 'node --check integrations/gnome/extension.js' "$workflow"
grep -Fq 'node --test tests/gnome-bridge.test.js' "$workflow"
grep -Fq 'tests/qjsvalue-variant-smoke.sh' "$workflow"
grep -Fq 'tests/aur-package-smoke.sh' "$workflow"
grep -Fq 'tests/deb-package-smoke.sh' "$workflow"
grep -Fq 'tests/apt-repository-smoke.sh' "$workflow"
grep -Fq 'tests/ppa-source-package-smoke.sh' "$workflow"
