...
test "$(overcrow_arch_version "$version")" = 0.1.0prealpha5
test "$(overcrow_rpm_version 0.1.0)" = 0.1.0
test "$(overcrow_rpm_version "$version")" = '0.1.0~pre_alpha.5'
test "$(overcrow_rpm_artifact_version 0.1.0)" = 0.1.0
test "$(overcrow_rpm_artifact_version "$version")" = '0.1.0.pre_alpha.5'
...
grep -Fq "<release version=\"$version\" date=\"2026-07-30\">" \
